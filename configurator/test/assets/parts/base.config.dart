...
class BaseScopeRouteKeys {
  const BaseScopeRouteKeys();
}
...
class BaseScopeConfigKeys {
  const BaseScopeConfigKeys();

  static final routes = const BaseScopeRouteKeys();
...
class GeneratedBaseScope extends ConfigScope {
  const GeneratedBaseScope();

  @override
  final String name = "__GeneratedBaseScope";
