...
class KeyWriter extends Writer {
  ...
  KeyWriter(String name, this._yamlConfiguration)
  ...
  Spec write() {
    ...
    Class routeKeys = Class((builder) {
      builder
        ...
        ..constructors.add(Constructor((b) => b..constant = true))
        ..fields.addAll([
          ..._yamlConfiguration.routes
              .map((e) => _buildField2((e.path).canonicalize, '${e.id}')),
        ]);
    });
    ...
    Class colorKeys = Class((builder) {
      builder
        ...
        ..constructors.add(Constructor((b) => b..constant = true))
        ..fields.addAll([
          ..._yamlConfiguration.colors
              .map((e) => _buildField((e.name as String).canonicalize)),
        ]);
    });
