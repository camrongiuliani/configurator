...
class ProcessedConfig {
  ...
  Future write(bool pureDart) async {
    ...
    builder.body.addAll([
      ...
      TextStyleWriter(
        frameworkName,
        yamlConfiguration.textStyles,
        pureDart: pureDart,
      ).write(),
      TitleWriter('Strings').write(),
      SlangWriter(yamlConfiguration.resolvedTranslations).write(),
      TitleWriter('Configuration').write(),
      ConfigWriter(
        name: frameworkName,
        weight: yamlConfiguration.weight,
        strings: yamlConfiguration.resolvedTranslations,
